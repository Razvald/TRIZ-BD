...
namespace OnlineShop_MVVM_.Database
{
    public class AppDbContext : DbContext
    {
        ...
        private static void SeedData(ModelBuilder modelBuilder)
        {
            ...
            {
                new() { ID = 1, CustomerID = 1, OrderDate = new DateTime(2024, 2, 5), TotalAmount = 12000, PickupPointID = 1 },
                new() { ID = 2, CustomerID = 2, OrderDate = new DateTime(2024, 2, 4), TotalAmount = 21000, PickupPointID = 2 },
                new() { ID = 3, CustomerID = 3, OrderDate = new DateTime(2024, 2, 3), TotalAmount = 28000, PickupPointID = 3 },
                new() { ID = 4, CustomerID = 4, OrderDate = new DateTime(2024, 2, 2), TotalAmount = 42000, PickupPointID = 4 },
                new() { ID = 5, CustomerID = 5, OrderDate = new DateTime(2024, 2, 1), TotalAmount = 15000, PickupPointID = 5 },
                new() { ID = 6, CustomerID = 2, OrderDate = new DateTime(2024, 2, 1), TotalAmount = 11000, PickupPointID = 2 }
            };
